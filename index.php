        ...
        <div class="popup-holder">
            <div class="popup-body">
                ...
                <div class="big-col centered">
                    ...
                    <div class="field">
                        <label for="user-email">Email:</label>
                        <input class="text-input" type="email" id="user-email">
                    </div>
                    <div class="field error">
                        <label for="user-pass">Пароль:</label>
                        <a href="#" class="label-link">Забыли?</a>
                        <input class="text-input" type="password" id="user-pass">
                        <span class="caption">Ошибка: пароль введен неверно.</span>
                    </div>
                    <div class="field checkbox-field">
                        <input class="checkbox-input" type="checkbox" id="user-remember">
                        <label for="user-remember">Запомнить меня</label>
                    </div>
                    <div class="field">
                        <a href="#" class="small-btn blue-btn">Войти</a>
                    </div>
                    <div class="hor-splitter"></div>
                    <p class="sub-dark-color">У вас еще нет аккаунта? <br /><a class="su-popup-trigger" href="#">Зарегистрируйтесь</a> и полуйчате бонусы.</p>
                </div>
        ...
        <div class="popup-holder">
            <div class="popup-body">
                ...
                <div class="big-col centered">
                    ...
                    <div class="field">
                        <label for="user-name">Ваше имя:</label>
                        <input class="text-input" type="email" id="user-name">
                    </div>
                    <div class="field">
                        <label for="user-email">Email:</label>
                        <input class="text-input" type="email" id="user-email">
                    ...
                    <div class="field">
                        <label for="user-pass-conf">Пароль еще раз:</label>
                        <input class="text-input" type="password" id="user-pass-conf">
                    </div>
                    <div class="field">
                        <a href="#" class="small-btn blue-btn">Зарегистрироваться</a>
                    </div>
...
>>>>>>> 3cd4d8e4b0b5b82314fd9da74bd356a3fa42b3df:index.html
</html>