                            ...
                            <table width="100%" cellspacing="0" cellpadding="15px" style="background: white; margin-top:20px; padding-top: 15px; -webkit-border-radius:10px; -moz-border-radius:10px; border-radius:10px;">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p>Для получения нового пароля перейдите по <a style="color:#bb1d1d; text-decoration:none;" href="http://exarium.ru/profile/forgot/?hash=<?php echo $url_hash; ?>">этой ссылке</a>. Ссылка действительна в течение 24 часов.</p>
